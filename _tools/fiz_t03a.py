...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=3, virsraksts="Mijiedarbības atpazīšana",
             ...
             aprekins=["1)  Smaguma spēks: Zeme ↔ grāmata",
                       "2)  Balsta reakcija: galds ↔ grāmata",
        ...
        dict(nr=6, virsraksts="Mijiedarbības pāri",
             ...
             aprekins=["1)  a) magnēts ↔ nagla (magnētiska)",
                       "2)  b) Zeme ↔ Mēness (gravitācijas)",
                       "3)  c) roka ↔ galds (saskares)"],
