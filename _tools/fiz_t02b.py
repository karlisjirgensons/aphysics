...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=4, virsraksts="g no svārsta mērījuma",
             ...
             jaaprekina=["g = ?"],
             formulas=["T = t/N", "T = 2π√(l/g)", "g = 4π²l/T²"],
...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=6, virsraksts="Ātruma virziens pie zemes",
             ...
             jaaprekina=["t = ?", "v_y = ?", "α = ?"],
             formulas=["h = gt²/2", "t = √(2h/g)", "v_y = gt", "tg α = v_y/v₀"],
             aprekins=["1)  t = √(10 : 9,8) = 1,01 s",
...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=6, virsraksts="Centrifūga astronautiem",
             ...
             jaaprekina=["v = ?", "T = ?"],
             formulas=["a = v²/R", "v = √(aR)", "v = 2πR/T", "T = 2πR/v"],
