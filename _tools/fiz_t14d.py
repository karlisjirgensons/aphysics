...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=3, virsraksts="Elektrības uzdevums",
             ...
             jaaprekina=["R = ?", "P = ?", "E = ?"],
             formulas=["I = U/R", "R = U/I", "P = UI", "P = A/t", "E = Pt"],
        ...
        ("Divu gadu karte", [
            ("tabula",
             ...
             [["Mehānika", "1.-5.", "v = s/t;  F = ma;  A = Fs;  E = mv²/2"],
              ["Viļņi un siltums", "6.-8.", "v = λ · f;  Q = cmΔT;  Q = ΔU + A"],
              ["Elektrība", "9.-11.", "I = U/R;  P = UI;  U₁/U₂ = N₁/N₂"],
              ["Optika un atoms", "12.-14.", "c = λ · f;  E = hf;  A = Z + N"]],
             [2.60, 2.20, 6.43]),
