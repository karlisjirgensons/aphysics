...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=4, virsraksts="Kur veidosies attēls",
             ...
             jaaprekina=["b = ?"],
             formulas=["1/f = 1/a + 1/b", "f = ab/(a + b)", "b = af/(a − f)"],
...
dict(
    ...
    uzdevumi=[
        dict(nr=1, virsraksts="Fokusa attālums no datiem",
             ...
             jaaprekina=["f = ?", "Γ = ?"],
             formulas=["1/f = 1/a + 1/b", "f = ab/(a + b)", "Γ = b/a"],
        ...
        dict(nr=4, virsraksts="Salīdzinājums ar shēmu",
             ...
             jaaprekina=["b = ?", "Γ = ?"],
             formulas=["1/f = 1/a + 1/b", "b = af/(a − f)", "Γ = b/a"],
