...
dict(
    ...
    uzdevumi=[
        dict(nr=1, virsraksts="Divi posmi ar starpstāvēšanu",
             ...
             jaaprekina=["s = ?", "v(vid) = ?"],
             formulas=["v = s/t", "s = v·t", "v(vid) = s(kop)/t(kop)"],
        ...
        dict(nr=6, virsraksts="Laiva turp un atpakaļ",
             ...
             jaaprekina=["t = ?", "v(vid) = ?"],
             formulas=["v(pa) = 10 km/h ;  v(pret) = 6,0 km/h", "v = s/t",
                       "t = s/v", "v(vid) = s(kop)/t"],
...
dict(
    ...
    uzdevumi=[
        dict(nr=1, virsraksts="Atrodi kļūdu I",
             ...
             jaaprekina=["s = ?", "kļūda = ?"],
             formulas=["Vispirms v uz m/s", "v = s/t", "s = v·t"],
