...
dict(
    ...
    uzdevumi=[
        dict(nr=1, virsraksts="Divas vienādas paralēli",
             ...
             dots=["R₁ = 60 Ω", "R₂ = 60 Ω"],
             jaaprekina=["R = ?"],
             formulas=["1/R = 1/R₁ + 1/R₂", "R = R₁R₂/(R₁ + R₂)"],
             aprekins=["1)  R₁R₂ = 3600",
                       "2)  R₁ + R₂ = 120",
                       "3)  R = 3600 : 120 = 30 Ω"],
             atbilde="R = 30 Ω",
...
dict(
    ...
    uzdevumi=[
        dict(nr=1, virsraksts="Kurš punkts kļūdains",
             ...
             formulas=["I = U/R", "R = U/I", "R jābūt nemainīgai"],
...
dict(
    ...
    uzdevumi=[
        dict(nr=1, virsraksts="Kombinēts uzdevums",
             ...
             jaaprekina=["I = ?", "P = ?", "E = ?"],
             formulas=["I = U/R", "P = UI", "P = A/t", "E = Pt"],
        ...
        dict(nr=2, virsraksts="Slēgums un jauda",
             ...
             jaaprekina=["R = ?", "I = ?", "P = ?"],
             formulas=["1/R = 1/R₁ + 1/R₂", "R = R₁R₂/(R₁ + R₂)", "I = U/R",
                       "P = UI"],
