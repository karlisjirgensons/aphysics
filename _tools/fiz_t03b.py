...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=4, virsraksts="Divas atsperes virknē",
             ...
             jaaprekina=["x₁ = ?", "x(kop) = ?"],
             formulas=["Katrā atsperē tas pats spēks", "F = kx", "x = F/k"],
        ...
        dict(nr=7, virsraksts="k no atsperes garuma",
             ...
             jaaprekina=["x = ?", "k = ?"],
             formulas=["x = l − l₀", "F = mg", "F = kx", "k = F/x"],
...
dict(
    ...
    uzdevumi=[
        ...
        dict(nr=5, virsraksts="Cik tālu uzslīdēs",
             ...
             jaaprekina=["a = ?", "s = ?"],
             formulas=["a = g(sin α + µ cos α)", "v² − v₀² = 2as",
                       "s = v₀²/(2a)"],
